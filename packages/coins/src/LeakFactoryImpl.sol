...
import {ILeakFactory} from "./interfaces/ILeakFactory.sol";
    ...
    DeployedCoinVersionLookup
{
    ...
    /// @notice The Leak coin contract implementation address
    ...
    /// @notice The Leak hook registry address
    address public immutable leakHookRegistry;
    ...
    constructor(address coinV4Impl_, address creatorCoinImpl_, address trendCoinImpl_, address hook_, address leakHookRegistry_) {
    ...
    function initialize(address initialOwner) external initializer {
        ...
        ILeakHookRegistry(leakHookRegistry).registerHooks(hooks, tags);
    }
    ...
    function _authorizeUpgrade(address newImpl) internal override onlyOwner {
        ...
        // Auto-register the new hooks in the Leak hook registry
        address[] memory hooks = new address[](1);
        string[] memory tags = new string[](1);

        hooks[0] = ILeakFactory(newImpl).hook();
        tags[0] = "CoinHook";
