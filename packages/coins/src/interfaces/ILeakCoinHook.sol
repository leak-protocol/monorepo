...
interface ILeakCoinHook is IUpgradeableV4Hook {
    ...
    error LeakLimitOrderBookCannotBeZeroAddress();

    /// @notice Thrown when the Leak hook registry is the zero address.
    error LeakHookRegistryCannotBeZeroAddress();
