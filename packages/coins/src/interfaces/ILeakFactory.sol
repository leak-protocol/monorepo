...
interface ILeakFactory is IDeployedCoinVersionLookup, ITrendCoinErrors {
    ...
    /// @notice The address of the Leak hook registry
    function leakHookRegistry() external view returns (address);
