...
library CoinConstants {
    ...
    bytes32 internal constant _BEFORE_SWAP_TICK_SLOT = keccak256("LeakCoinHook.beforeSwap.tick");
    ...
    /// @dev leak.ai / Avalanche C-Chain: WAVAX. Zora used $ZORA on Base here.
    ///      This is the ONLY chain-specific address in production source.
    address internal constant CREATOR_COIN_CURRENCY = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    ...
    /// @dev Pre-encoded bytes for version 4 with 3 curves. Currency word = CREATOR_COIN_CURRENCY
    ///      (WAVAX on Avalanche); setTrendCoinPoolConfig rejects any other currency.
    ...
    bytes internal constant TREND_COIN_DEFAULT_POOL_CONFIG =
        hex"";
}
