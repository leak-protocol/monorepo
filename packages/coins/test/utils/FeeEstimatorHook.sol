...
/// @dev Test util - meant to be able to etched where a normal backing hook is, to gather the fees from swaps but not distribute them
contract FeeEstimatorHook is LeakCoinHook {
    ...
    constructor(
        ...
        ILeakLimitOrderBook leakLimitOrderBook,
        ILeakHookRegistry leakHookRegistry
    ) LeakCoinHook(_poolManager, _coinVersionLookup, trustedMsgSenderLookup, upgradeGate, leakLimitOrderBook, leakHookRegistry) {}
    ...
    function _afterSwap(
...

        {
            ...
            // This mirrors the logic in LeakCoinHook._afterSwap
