...
interface IProtocolRewards {
    ...
    /// @param backing BACKING recipient
    ...
    /// @param backingReward BACKING amount
    ...
    /// @notice Used by Backing ERC-721 & ERC-1155 contracts to deposit protocol rewards
    /// @param creator Creator for NFT rewards
    /// @param creatorReward Creator reward amount
    /// @param createReferral Creator referral
    /// @param createReferralReward Creator referral reward
...
contract ProtocolRewards is Enjoy, IProtocolRewards, EIP712 {
    ...
    function depositRewards(
        ...
        if (msg.value != (creatorReward + createReferralReward + mintReferralReward + firstMinterReward + backingReward)) {
            revert INVALID_DEPOSIT();
        }
        ...
        unchecked {
            ...
            if (backing != address(0)) {
                balanceOf[backing] += backingReward;
            }
        }
