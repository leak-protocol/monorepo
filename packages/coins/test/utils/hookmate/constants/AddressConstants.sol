...
library AddressConstants {
    ...
    function getPoolManagerAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 7777777) {
            return address(0x0575338e4C17006aE181B47900A84404247CA30f); // Backing
        }
        if (chainId == 480) {
    ...
    function getPositionManagerAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 7777777) {
            return address(0xf66C7b99e2040f0D9b326B3b7c152E9663543D63); // Backing
        }
        if (chainId == 480) {
    ...
    function getV4SwapRouterAddress(uint256 chainId) internal pure returns (address) {
        ...
        if (chainId == 7777777) {
            return address(0x1770E250A9b67E44206542148ed7C5Df38235003); // Backing
        }
        if (chainId == 480) {
