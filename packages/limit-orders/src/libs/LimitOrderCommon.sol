...
library LimitOrderCommon {
    ...
    function _updateMakerBalanceAndEmit(
        ...
        emit ILeakLimitOrderBookFull.LimitOrderCreated(
            ctx.maker,
            ctx.coin,
            ctx.poolKeyHash,
            ctx.isCurrency0,
        ...
        emit ILeakLimitOrderBookFull.MakerBalanceUpdated(ctx.maker, ctx.coin, newMakerBalance);
    }
    ...
    function removeOrder(
        ...
        emit ILeakLimitOrderBookFull.MakerBalanceUpdated(maker, coin, newMakerBalance);
    }
}
