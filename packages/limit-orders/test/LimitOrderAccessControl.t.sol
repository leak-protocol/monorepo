...
contract LimitOrderAccessControlTest is BaseTest {
    ...
    function test_nonHookCannotFillWhileUnlocked() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.UnlockedFillNotAllowed.selector);
    ...
    function test_fillBatchIgnoresEmptyOrderArrays() public {
        ...
        ILeakLimitOrderBookFull.OrderBatch[] memory batches = new ILeakLimitOrderBookFull.OrderBatch[](3);
        batches[0].key = key;
    ...
    function test_unlockCallbackRevertsForNonPoolManager() public {
        vm.expectRevert(ILeakLimitOrderBookFull.NotPoolManager.selector);
...
contract UnlockedFillCaller {
    ILeakLimitOrderBookFull public immutable limitOrderBook;
    ...
    constructor(address _limitOrderBook, address _poolManager) {
        limitOrderBook = ILeakLimitOrderBookFull(_limitOrderBook);
