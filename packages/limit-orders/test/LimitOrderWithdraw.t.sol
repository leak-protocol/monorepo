...
contract LimitOrderWithdrawTest is BaseTest {
    ...
    function test_withdrawRevertsForFillableOrder() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.OrderFillable.selector);
        vm.prank(users.seller);
        limitOrderBook.withdraw(orderIds, orderCoin, 0, users.seller);
    }
    ...
    function test_withdrawOrdersRevertsForMixedCoins() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ILeakLimitOrderBookFull.CoinMismatch.selector, mismatchOrderId, expectedCoin, actualCoin));
        vm.prank(users.seller);
    ...
    function test_withdrawOrdersRevertsForRecipientZero() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.AddressZero.selector);
        vm.prank(users.seller);
    ...
    function test_withdrawOrdersRevertsForNonMaker() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.OrderNotMaker.selector);
    ...
    function test_withdrawOrdersRevertsOnInvalidOrder() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.InvalidOrder.selector);
        vm.prank(users.seller);
    ...
    function test_withdrawOrdersRevertsOnClosedOrder() public {
        ...
        vm.expectRevert(ILeakLimitOrderBookFull.OrderClosed.selector);
        vm.prank(users.seller);
    ...
    function test_withdrawWithMinAmountOutRevertsIfNotReached() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ILeakLimitOrderBookFull.MinAmountNotReached.selector, actualTotal, minAmountOut));
        vm.prank(users.seller);
    ...
    function test_makerBalanceUpdated_emittedOnWithdraw() public {
        ...
        for (uint256 i; i < logs.length; ++i) {
            if (logs[i].topics[0] == ILeakLimitOrderBookFull.MakerBalanceUpdated.selector) {
...
contract ReentrancyAttacker {
    ILeakLimitOrderBookFull public limitOrderBook;
    bytes32 public targetOrderId;
    address public coin;
    bool public attackSucceeded;
    bool public attacked;

    constructor(ILeakLimitOrderBookFull _limitOrderBook, bytes32 _targetOrderId, address _coin) {
