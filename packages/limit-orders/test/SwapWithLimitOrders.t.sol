...
contract SwapWithLimitOrdersTest is BaseTest {
    ...
    function test_unallocatedCoinsRefundedAndReferralPaid() public {
        ...
        uint256 referralBalanceBefore = _balanceOf(address(backingToken), users.tradeReferrer);
        ...
        uint256 referralBalanceAfter = _balanceOf(address(backingToken), users.tradeReferrer);
